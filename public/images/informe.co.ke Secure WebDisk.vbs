' informe.co.ke Secure WebDisk.vbs
'
...
' *************************************************************************
strURL = "\\informe.co.ke@SSL@2078\DavWWWRoot" ' This is the URL to the WebDAV share.
strDomainPort = "informe.co.ke@SSL@2078"
...
Sub CreateShorty ()
   ...
   strName = "informe.co.ke Secure WebDisk"
